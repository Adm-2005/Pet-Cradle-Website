export default function Volunteer() {
  return (
    <section id="volunteer" className="px-16 sm:px-8">
      <div className="flex flex-col justify-start gap-5">
        <h2 className="max-sm:text-4xl text-6xl max-sm:mx-auto text-red-600 mt-10 font-palanquin font-bold">
          Contact Us
        </h2>
      </div>
      <form className="mt-10 flex flex-1 flex-col shadow-2xl rounded-xl  px-8 xl:px-20 py-4 mb-4 mx-auto bg-white border w-fit">
